...
<div class="grundtext">
    <h2> Gemeinsam für den Breitensport</h2>
...
<img src="{{ '/assets/images/gruppen/verband.png' | relative_url }}" class="hero-image" />

<div class="grundtext">
    <h2> Ein starker Verband im Wandel der Zeit</h2>
