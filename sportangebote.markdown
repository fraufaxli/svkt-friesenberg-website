...
[MäTu]({{ '/mae-tu' | relative_url }}) Mädchenturnen<br>
[Teen-Dance]({{ '/teen-dance' | relative_url }}) Tanzendes Fitness<br><br>

## Ressort Erwachsene
### Mit Jahresbeitrag
[Volleyball]({{ '/volleyball' | relative_url }})<br>
[Gymnastik]({{ '/gymnastik' | relative_url }})<br>
[Gymnastik für Seriorinnen]({{ '/sen-gym' | relative_url }})<br>
[Fitness]({{ '/fitness' | relative_url }})<br><br>

### Kurs – Semesterbeitrag
[Latin-Aerobic-Dance]({{ '/lada' | relative_url }})<br>
[Aqua-Gymnastiik]({{ '/aqua' | relative_url }})<br>
[Pilates für Alle]({{ '/pilates' | relative_url }})<br><br>
